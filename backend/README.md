...
## Project Structure
    ...
    ├── corporate_actions_u_38463  # Django project configurations
...
1. Clone this repo and `cd corporate_actions_u_38463`
...
2. Clone this repo and `cd corporate_actions_u_38463`
